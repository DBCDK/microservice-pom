...
- Update flyway from 11.4.1 to 12.6.1 [flyway release notes](https://documentation.red-gate.com/fd/release-notes-for-flyway-engine-179732572.html)
...
- Update maven-ejb-plugin from 3.2.1 to 3.3.0
...
- Update maven-war-plugin from 3.4.0 to 3.5.1
...
- Update payara 6.2025.2 to 6.2025.11
...
- Update payara version from 6.2024.6 to 6.2025.2
...
- Update payara version from 6.2023.11 to 6.2024.6 [payara release notes](https://docs.payara.fish/community/docs/Release%20Notes/Release%20Notes%206.2024.6.html)
...
- Update maven-ejb-plugin from 3.1.0 to 3.2.1
